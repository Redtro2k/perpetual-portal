...
const classes = computed(() => {
    return props.active
        ? 'block pl-3 pr-4 py-2 border-l-4 border-indigo-400 text-base font-medium text-jvgreen bg-indigo-50 focus:outline-none focus:text-jvdgreen focus:bg-jvgreen focus:border-jvdgreen transition'
