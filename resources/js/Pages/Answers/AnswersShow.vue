                                                    ...
                                                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                                        ...
                                                        <dd class="mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                            ...
                                                            <span class="ml-4 flex-shrink-0">
                                                                <Link v-show="is_completed.is_complete == 0" :href="route('compute')" method="post" type="button" as="button" :data="{activities_id: current_id}" class="bg-white rounded-md font-medium text-jvdgreen hover:text-jvgreen focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jvgreen">Finish</Link>
                                                            </span>
                                                        </dd>
                                                    </div>
                                                </dl>
